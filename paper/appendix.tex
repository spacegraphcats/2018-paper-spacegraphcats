...
See Table~\ref{tab:binstats}, Table~\ref{tab:completeness}, and 
...
queries. Table~\ref{tab:completeness} shows percent completeness and increased 
completeness for MEGAHIT and \plass assemblies of the query neighborhoods. 
Table~\ref{tab:nbhdstats} shows completeness metrics for \plass assembled
query neighborhoods after stringent k-mer trimming (k > 5) of the SB1 sample
reads.  
...
\begin{table*}
  \begin{tabular}{l c c c c c c}
    ...
    \midrule
    \input{tables/bin-stats.tex}
\\ 
   \bottomrule
  \end{tabular}
  \caption{\label{tab:binstats}
   Completeness metrics for the \hu queries. Completeness, redundancy, and 
   ...
   ``contamination'' as ``redundancy'' as this better describes the strain 
   variation in single copy genes captured by spacegraphcats queries.}
  \label{tab:binstats}
 \end{table*}
...
\begin{table*}
  \begin{tabular}{l c c c c c c}
    ...
    Species & Completeness (\%) & Redundancy (\%) & Strain heterogeneity (\%) & Unique KOs & Size (bases) & Number of proteins \\
    \midrule
    \input{tables/nbhd-stats.tex}
\\
    \bottomrule
  \end{tabular}
  \caption{\label{tab:nbhdstats}
   Completeness metrics for the query neighborhoods. Completeness, redundancy, 
   ...
   for which we used the neighborhood unitig sequences output by spacegraphcats.}
  \label{tab:nbhdstats}
 \end{table*}
