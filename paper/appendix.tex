...
\begin{table*}
  \begin{tabular}{l c c c c c c}
    \toprule
    Species & Completeness & Contamination & Strain heterogeneity & Unique KOs & Size (bases) & Number of proteins \\
    \midrule
...
\\ 
  ...
  \caption{\label{tab:binstats}
   Completeness, contamination, and strain heterogeneity as estimated
