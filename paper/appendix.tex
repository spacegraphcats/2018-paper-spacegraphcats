...
See Table~\ref{tab:completeness}, Table~\ref{tab:binstats}, and 
Table~\ref{tab:nbhdstats}.
...
\\ 
  ...
  \caption{\label{tab:binstats}
   Completeness, redundancy, and strain heterogeneity as estimated
   ...
   Note we refer to the checkM term "contamination" as "redundancy" as this
   better describes the strain variation in single copy genes captured by 
...
\\
  ...
  \caption{\label{tab:nbhdstats}
   ...
   query neighborhoods. All estimates were performed on the plass-assembled
   proteins except size of neighborhood in bases, for which we used the 
   neighborhood unitig sequences output by spacegraphcats.}
  \label{tab:nbhdstats}
 \end{table*}
