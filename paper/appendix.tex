...
\begin{table*}
  ...
  \begin{tabular}{@{}l l c c @{}}
    ...
    \midrule
    % generated from notebook 'figures/plass-genes/distinct_positions.ipynb'
...
\begin{table}
  \begin{tabular}{l c}
    ...
    \input{figures/megahit-inclusion.table.tex}
%    \input{figures/plass-genes/rpsC-table.tex}
    \bottomrule
  \end{tabular}
...
\begin{table}
  \begin{tabular}{l l c c }
    ...
    \midrule
    % generated from notebook 'figures/plass-genes/distinct_positions.ipynb'
    \input{figures/plass-genes/alaS-table.tex}
    \bottomrule
  \end{tabular}
...
\begin{table}
  \begin{tabular}{l l c c }
    ...
    \midrule
    % generated from notebook 'figures/plass-genes/distinct_positions.ipynb'
    \input{figures/plass-genes/gyrB-table.tex}
    \bottomrule
  \end{tabular}
...
\begin{table}
  \begin{tabular}{l l c c }
    ...
    \midrule
    % generated from notebook 'figures/plass-genes/distinct_positions.ipynb'
    \input{figures/plass-genes/recA-table.tex}
    \bottomrule
  \end{tabular}
...
\begin{table}
  \begin{tabular}{l l c c }
    ...
    \midrule
    % generated from notebook 'figures/plass-genes/distinct_positions.ipynb'
    \input{figures/plass-genes/rpb-table.tex}
    \bottomrule
  \end{tabular}
...
\begin{table}
  \begin{tabular}{l l c c }
    ...
    \midrule
    % generated from notebook 'figures/plass-genes/distinct_positions.ipynb'
    \input{figures/plass-genes/rplB-table.tex}
    \bottomrule
  \end{tabular}
